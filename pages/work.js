        ...
        <div className="px-10 sm:px-20 md:px-32 md:-mb-52 lg:mb-0 lg:px-60 mx-auto">
            ...
            <main className="min-h-screen max-w-screen ">
                <div className="pt-24 flex flex-col items-center mx-auto">
                    ...
                    <p className="mt-8 text-center w-[70%] mx-auto text-sm md:text-md lg:text-lg mb-2 ">
                        From websites with pastel hues to intelligent ML models, I love infusing a
                        little bit of playfulness into everything I create. So go ahead, and take a
                        look around 💖
                    </p>
