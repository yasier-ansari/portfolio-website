        ...
        <div className="px-10 sm:px-20 md:px-32 md:-mb-52 lg:mb-0 lg:px-60 mx-auto">
            ...
            <main className="min-h-screen max-w-screen ">
                <div className="pt-20 flex flex-col items-center mx-auto">
                    <h2
                        className={` selection:text-black/40 font-deca dark:selection:text-white/40  bg-gradient-to-tr from-fuchsia-500 via-purple-400 to-sky-700 bg-clip-text text-transparent items-center mx-auto text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold`}
                    >
                        Mark it! 🔖
                    </h2>
                    ...
                    </p>
                    {
                        !loggedin ? (
                            <>
                                <div className="select-none flex flex-col w-[85%] animate-pulse bg-stone-100 border-2 border-stone-300 p-4 rounded-xl  sm:w-[75%] md:w-[65%] max-w-3xl justify-center space-y-6 items-center mt-2 text-gray-400">
                            ...
                            !userInfo ? (
                                ...
                                <div className="flex flex-col w-[85%] sm:w-[80%] md:w-[65%] max-w-2xl justify-center items-center mt-2 dark:bg-zinc-200/20 bg-zinc-200/60 border dark:border-stone-100/20 border-stone-300 shadow-lg rounded-xl p-5 lg:p-8 " >
                                    <form className="w-full mx-auto flex flex-col items-center"
                                        ...
                                        ></textarea>
                                        {/* {tweetLimitExceeded && <p>You have reached the maximum tweet limit.</p>}
                                    {tweetCooldown && <p>You can post the next tweet after 24 hours.</p>} */}
