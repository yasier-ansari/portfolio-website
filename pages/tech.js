            ...
            <div className="min-h-[75vh] md:min-h-[73vh] px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 xl:px-80 mx-auto">
                <main className=" max-w-screen max-w-5xl mx-auto">
                    <div className="pt-24 flex flex-col mx-auto">
                        <h2 className="bg-gradient-to-tr dark:selection:text-white/80 selection:text-black/70 to-yellow-400 from-red-500 bg-clip-text text-transparent items-center mx-auto text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-out font-extrabold ">
                            Tech-stack
                        </h2>
