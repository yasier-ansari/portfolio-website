const Footer = () => {
    return (
        <div className=" flex text-sm text-gray-600 py-16 mt-16 flex-col h-max items-center mx-auto justify-center">
            ...
            <h3 className="font-[900] font-space animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl">
                Noru
            </h3>
