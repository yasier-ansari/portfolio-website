    ...
    return (
        <div className="relative">
            <div className="absolute right-20 -z-10 h-screen w-full">
                <div className="outline outline-gray-200 outline-[30px] border-gray-500 border-[40] animate-mainBlob1 absolute top-[23rem] right-24 md:top-[20rem] md:right-52 lg:top-10 lg:-right-10 w-[7rem] h-[8.5rem] md:w-40 md:h-[12rem] lg:w-60 lg:h-[17rem] rounded-full bg-[#FF4095] mix-blend-multiply filter blur-[30px]  opacity-60 "></div>
