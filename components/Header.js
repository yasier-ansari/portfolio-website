...
const Header = () => {
    return (
        <nav className="font-quick z-40 w-[45%] h-max bg-white shadow-sm mx-auto px-6 bg-opacity-[0.3] drop-shadow-lg backdrop-blur-sm top-4 sticky py-2 flex justify-between items-center space-x-6 rounded-xl " >
            <Link href={'/'} className="" >
