...
const Header = () => {
    return (
        <nav className=" z-40 w-[45%] h-max bg-white shadow-sm mx-auto px-6 bg-opacity-30 drop-shadow-lg backdrop-blur-md top-4 sticky py-2 flex justify-between items-center space-x-6 rounded-xl " >
            <Link href={'/'} className="" >
