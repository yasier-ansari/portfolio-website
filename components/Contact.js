...
const Contact = () => {
    return (
        <div class="h-max xl:px-20 2xl:px-40 lg:h-[22rem] p-6 sm:p-8 md:p-10 pt-32 md:pt-40 lg:p-10 bg-gradient-to-tr from-[#f6ebeb] to-[#ecf7ff] flex flex-col lg:flex-row mx-auto rounded-3xl drop-shadow-2xl backdrop-blur-xl items-center justify-center lg:justify-between ">
            <div className="order-2 sm:w-[75%] lg:w-[80%] xl:w-[70%] lg:basis-[60%] flex flex-col space-y-6 cirGradient bg-clip-text">
                ...
                <p class=" text-xs sm:text-sm md:text-md  lg:text-lg xl:text-xl">
                    Want to create something awesome? Or, you have any query? Drop an email or tweet
                </p>
                <div class="grid grid-cols-2 text-[0.7rem] md:text-[0.85rem] xl:text-base gap-2 md:gap-3 lg:gap-4">
                    <a
